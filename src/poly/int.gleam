...
pub fn from_list(coefficients: List(Int)) -> Polynomial(Descending) {
  poly.from_list(coefficients)
}

/// Create an ascending polynomial from a list of coefficients.
pub fn from_list_ascending(coefficients: List(Int)) -> Polynomial(Ascending) {
  poly.from_list_ascending(coefficients)
}

/// Get the list of coefficients from the poly.
pub fn coefficients(polynomial: Polynomial(order)) -> List(Int) {
